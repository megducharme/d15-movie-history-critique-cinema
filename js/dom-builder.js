...
function populateUserMovies(fbmovieData) {
    console.log("populate user movies is running");
    $("#movieOutput").html("");
    ...
    $("#movieOutput").append(`
      ...
      <h4>${movie.Release}</h4>
      <h4>${movie.Actors}</h4>
      <button class="addToUnwatched">Add this to your unwatched list</button>
      <button class="addToWatched">add this to your already watched list</button>
